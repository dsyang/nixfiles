{
  description = "Dan's nix-darwin system adopted from https://gist.github.com/jmatsushita/5c50ef14b4b96cb24ae5268dab613050";
  ...
  in
  {
    ...
    darwinConfigurations = rec {
      # name should be computer hostname
      Dans-Work-MBP = darwinSystem {
        ...
        modules = attrValues self.darwinModules ++ [ 
          ...
          home-manager.darwinModules.home-manager
          {
            ...
            home-manager.users.dsyang = import ./home.nix;            
          }
        ];
      };
    };
